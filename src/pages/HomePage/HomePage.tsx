        ...
        <section className={styles.textSection}>
          ...
          <div className={styles.descriptionContainer}>
            ...
            <p className={styles.description}>
              Платформа предлагает все необходимое для развития молодого онлайн-образовательного предприятия. Все
              инструменты для маркетинга, продаж объединены в одном месте.
            </p>
          </div>
